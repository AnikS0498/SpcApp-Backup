...
public class AdminController {
	...
	public ResponseEntity<Parent> updateParentDetails(@RequestBody Parent parent,
	...
	public ResponseEntity<Teacher> updateTeacherDetails(@RequestBody Teacher teacher,
			@RequestParam String standardIdList, @RequestParam String standardId) {

		return new ResponseEntity<Teacher>(teacherService.updateTeacher(teacher, standardIdList, standardId),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Standard> updateStandardDetails(@RequestBody Standard standard,
			@RequestParam List<Integer> studentIdList) {
